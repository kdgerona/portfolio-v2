...
export type Project = {
  ...
  role?: string;
  description: string;
  /** A standout fact rendered as a highlighted callout below the description. */
  highlight?: string;
    ...
    projects: [
      {
        ...
        role: "Founder",
        description:
          "A cloud-based, multi-tenant store management and real-time monitoring platform designed and built end-to-end as founder. Spans an Android mobile app, web admin portals for both individual stores and companies, a backend API, and the underlying database architecture.",
        highlight:
          "In production with a partner company that runs Kioscify across all of its company-owned stores, plus franchisee-owned stores that are active subscribers.",
        tags: [
          "ReactJS",
          "Redux",
          "React Native",
        ...
        images: [
          "/projects/kioscify/01.jpeg",
          "/projects/kioscify/02.jpeg",
          "/projects/kioscify/03.jpeg",
          "/projects/kioscify/04.jpeg",
          "/projects/kioscify/05.jpeg",
          "/projects/kioscify/06.jpeg",
          "/projects/kioscify/07.jpeg",
          "/projects/kioscify/08.jpeg",
          "/projects/kioscify/09.jpeg",
          "/projects/kioscify/10.png",
          "/projects/kioscify/11.png",
          "/projects/kioscify/12.png",
          "/projects/kioscify/13.png",
          "/projects/kioscify/14.png",
          "/projects/kioscify/15.png",
          "/projects/kioscify/16.png",
          "/projects/kioscify/17.png",
          "/projects/kioscify/18.png",
          "/projects/kioscify/19.png",
          "/projects/kioscify/20.png",
          "/projects/kioscify/21.png",
          "/projects/kioscify/22.png",
          "/projects/kioscify/23.png",
        ],
        links: [
          {
            label: "Store Portal",
            url: "https://store.kioscify.com/login",
            kind: "live",
          },
          {
            label: "Company Portal",
            url: "https://greatserve.kioscify.com/login",
            kind: "live",
          },
          {
            label: "Code",
            url: "https://github.com/kdgerona/Kioscify",
            kind: "github",
          },
        ],
    ...
    projects: [
      {
        ...
        images: [
          "/projects/skaiform/01.png",
          "/projects/skaiform/02.png",
          "/projects/skaiform/03.png",
          "/projects/skaiform/04.png",
          "/projects/skaiform/05.png",
        ],
        links: [
          {
            label: "Live site",
            url: "https://alpha.platform.skaiform.com/",
            kind: "live",
          },
        ],
        privateCode: true,
    ...
    projects: [
      {
        ...
        images: [
          "/projects/the-desktop/01.png",
          "/projects/the-desktop/02.png",
          "/projects/the-desktop/03.png",
          "/projects/the-desktop/04.png",
          "/projects/the-desktop/05.png",
          "/projects/the-desktop/06.png",
          "/projects/the-desktop/07.png",
          "/projects/the-desktop/08.png",
        ],
        links: [
          {
            label: "Live site",
            url: "https://auth.thedesktop.com.au/login",
            kind: "live",
          },
        ],
        privateCode: true,
    ...
    projects: [
      {
        ...
        images: [
          "/projects/ground-command/01.jpeg",
          "/projects/ground-command/02.png",
          "/projects/ground-command/03.png",
          "/projects/ground-command/04.png",
...
export const otherProjects: OtherProject[] = [
  ...
  },
  {
    ...
    description: "XState client machine executing workflow tasks over gRPC.",
    language: "TypeScript",
